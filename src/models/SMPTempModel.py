    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        if encoder_weights == "pastis": 
            ...
            primary_ckpt = '/develop/data/utae_pre_simclr/model.pth.tar'
            secondary_ckpt = '/develop/code/WildfireSpreadTS-Sameep/src/models/utae_paps_models/Gallelio-weights/simclr.tar'
            pretrained_checkpoint = primary_ckpt if os.path.exists(primary_ckpt) else secondary_ckpt
            self.load_checkpoint(pretrained_checkpoint)       
